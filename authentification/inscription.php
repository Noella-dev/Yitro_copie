...
<body>
    ...
    <header>
        <nav class="main-nav">
            <div class="container">
                <div class="logo">
                    <img src="../asset/images/logo.png" type="image/png" alt="Yitro Learning">
                ...
                <ul class="nav-list">
                    ...
                    <li class="dropdown">
                        <a href="../page/catalogue.php">Nos formations</a>
                       <!-- <ul class="dropdown-menu">
                            <li class="dropdown">
        ...
        <div class="container">
            <div class="footer-links">
                <div class="footer-column">
                    <h4>Suivez-nous</h4>
                    <ul>
                        <li>Suivez-nous sur les réseaux sociaux. Restez connecté avec SK Yitro Consulting pour les dernières mises à jour et actualités.</li>
                    </ul>
                </div>
                <div class="footer-column">
